package com.android.zd112.ui.view.sticky;
...
import com.android.zd112.utils.GeometryUtil;
import com.android.zd112.utils.ScreenUtils;

/**
 * Created by etongdai on 2018/3/13.
 */
...
//      需要手动测量
        ...
        mFixRadius = ScreenUtils.dip2Dimension(8, mContext);
        mFarthestDistance = ScreenUtils.dip2Dimension(80, mContext);
        mMinFixRadius = ScreenUtils.dip2Dimension(3f, mContext);
