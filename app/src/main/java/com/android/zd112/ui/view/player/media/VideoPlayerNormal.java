...
public class VideoPlayerNormal extends VideoPlayer {
    ...
    public VideoPlayerNormal(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(MediaOptionNormal.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                ...
                onEvent(MediaOptionNormal.ON_CLICK_START_THUMB);
                startVideo();
            ...
            final LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.view_clarity, null);
            ...
            for (int j = 0; j < ((LinkedHashMap) dataSourceObjects[0]).size(); j++) {
                ...
                TextView clarityItem = (TextView) View.inflate(getContext(), R.layout.view_clarity_item, null);
            ...
            onStatePreparing();
            onEvent(MediaOption.ON_CLICK_START_ERROR);
        }
    }
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                onEvent(MediaOptionNormal.ON_CLICK_START_WIFIDIALOG);
                startVideo();
