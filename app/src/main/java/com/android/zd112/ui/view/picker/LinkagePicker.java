...
import com.android.zd112.ui.view.picker.entity.LinkageFirst;
import com.android.zd112.ui.view.picker.entity.LinkageSecond;
import com.android.zd112.ui.view.picker.entity.LinkageThird;
import com.android.zd112.ui.view.picker.widget.WheelView;
...
public class LinkagePicker<Fst extends LinkageFirst<Snd>, Snd extends LinkageSecond<Trd>, Trd> extends WheelPicker {
    ...
    public void setSelectedItem(Fst fst, Snd snd, Trd trd) {
        ...
        LogUtils.e("init select first: " + fst.getName() + ", index:" + selectedFirstIndex);
        //noinspection unchecked
        ...
        LogUtils.e("init select second: " + snd.getName() + ", index:" + selectedSecondIndex);
        ...
        LogUtils.e("init select third: " + trd + ", index:" + selectedThirdIndex);
    }
    ...
    protected View makeCenterView() {
        ...
        firstView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                LogUtils.e("change second data after first wheeled");
        ...
        secondView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                if (!provider.isOnlyTwo()) {
                    LogUtils.e("change third data after second wheeled");
                    selectedThirdIndex = 0;//重置第三级索引
                    //noinspection unchecked
                    List<Trd> trds = provider.linkageThirdData(selectedFirstIndex, selectedSecondIndex);
                    selectedThirdItem = trds.get(selectedThirdIndex);
