...
public class PrintUtil {
    ...
    public static void printTest(BluetoothSocket bluetoothSocket, Bitmap bitmap, String content) {
        ...
        try {
            ...
            pUtil.printTwoColumn("时间:", time);
            pUtil.printLine();

            pUtil.printTwoColumn("订单号:", System.currentTimeMillis() + "");
            pUtil.printLine();

            pUtil.printTwoColumn("付款人:", "jankey");
            pUtil.printLine();
            ...
            if (content != null) {
                ...
                pUtil.printThreeColumn("杰克面", "1", "28.00");
                pUtil.printThreeColumn("推荐的黄金鱼....买一送一", "2", "88.00");

                pUtil.printDashLine();
                pUtil.printLine();

                pUtil.printTwoColumn("订单金额:", "116.00");
                pUtil.printLine();

                pUtil.printTwoColumn("实收金额:", "120.00");
                pUtil.printLine();

                pUtil.printTwoColumn("找零:", "4.00");
                pUtil.printLine();
            }
